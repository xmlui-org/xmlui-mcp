...
const CODE = `<Badge variant="pill" value="test content"/>`;

test("pill: fontSize", async ({ initTestBed, createBadgeDriver }) => {
...
test("pill: fontWeight", async ({ initTestBed, createBadgeDriver }) => {
  // bold font weight
